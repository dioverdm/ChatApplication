...
var headerSchema = zod_1.z.object({
...
var authMiddleware = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        try {
            authorization = headerSchema.parse(req.headers).authorization;
            // console.log(authorization);
            if (!authorization.startsWith('Bearer'))
                return [2 /*return*/, res.send('Send token in proper format!!')];
            ...
            return [2 /*return*/, res.status(401).send("Not authorized, token failed")];
